    ...
    <div class="main-container d-flex">
        ...
        <div class="content mb-2">
            ...
            <div class="tab-titles">
                ...
                <a href="report-cuti.php" style="text-decoration: none;" class="tab-links active-link">
                    Ringkasan Cuti
                </a>
                ...
                <div class="card">
                    ...
                    ?>
                        <div class="card-body">
                            ...
                            <a href="report-csv.php?a=C&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-success">Export CSV</a>
                            <a href="report-csv.php?a=D&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin menghapus Data ?')">Delete All Data</a>
                        </div>
                    <?php } else { ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM cuti INNER JOIN user ON cuti.idpegawai = user.idpegawai WHERE status = 'Y' ORDER BY id_cuti DESC");
                                    $no = 1;
