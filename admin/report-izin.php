    ...
    <div class="main-container d-flex">
        ...
        <div class="content mb-2">
            ...
            <div class="tab-titles">
                <a href="report-karyawan.php" style="text-decoration: none;" class="tab-links">
                    Report Karyawan
                </a>
                ...
                <a href="report-izin.php" style="text-decoration: none;" class="tab-links active-link">
                    Ringkasan Izin
                </a>
            </div>
                    ...
                    ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                    ...
                                    <tr>
                                        <td colspan="9" align="center">
                                            <h5 class="m-0 font-weight-bold text-primary text-center">
                                                Laporan Izin Karyawan Dari <?php echo $tgl1 ?> s/d <?php echo $tgl2 ?>
                                            </h5>
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                    $lam = mysqli_query($con, "SELECT * FROM izin INNER JOIN user ON izin.idpegawai = user.idpegawai WHERE tgl_mulai BETWEEN '$tgl1' AND '$tgl2' AND status = 'Y' ORDER BY id_izin DESC");
                                    $no = 1;
                            ...
                            <a href="report-csv.php?a=I&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-success">Export CSV</a>
                            <a href="report-csv.php?a=DI&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin menghapus Data ?')">Delete All Data</a>
                        </div>
                    <?php } else { ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM izin INNER JOIN user ON izin.idpegawai = user.idpegawai WHERE status = 'Y' ORDER BY id_izin DESC");
                                    $no = 1;
