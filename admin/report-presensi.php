    ...
    <div class="main-container d-flex">
            ...
            <div class="header-box px-2 pt-3 pb-4 ">
                ...
                <ul class="list-unstyled px-3 py-4">
                    ...
                    <li><a href="data.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa fa-list"></i>
                            Data Karyawan</a></li>
                    <li class="active"><a href="report.php" class="text-decoration-none px-3 py-2 d-block"><i class="fa-sharp fa-solid fa-book"></i>
        ...
        <div class="content mb-2">
            ...
            <div class="tab-titles">
                <a href="report-karyawan.php" class="tab-links" style="text-decoration: none;">
                    Report Karyawan
                </a>
                <a href="report-presensi.php" class="tab-links active-link" style="text-decoration: none;">
                    Ringkasan Presensi
                </a>
                    ...
                    ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $lam = mysqli_query($con, "SELECT * FROM user INNER JOIN absensi ON user.idpegawai = absensi.idpegawai WHERE tgl_absen  BETWEEN '$tgl1' AND '$tgl2' AND bagian != 'Admin' ORDER BY tgl_absen DESC");
                                    $no = 1;
                            ...
                            <a href="report-csv.php?a=P&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-success">Export CSV</a>
                            <a href="report-csv.php?a=DP&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda Yakin Ingin menghapus Data ?')">Delete All Data</a>
                        </div>
                    <?php } else { ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM user INNER JOIN absensi ON user.idpegawai = absensi.idpegawai WHERE bagian != 'Admin' ORDER BY tgl_absen DESC");
                                    $no = 1;
