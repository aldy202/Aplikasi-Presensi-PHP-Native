    ...
    <div class="main-container d-flex">
        ...
        <div class="content mb-2">
            ...
            <div class="tab-titles">
                ...
                <a href="ringkasan-izin-karyawan.php" class="tab-links active-link" style="text-decoration: none;">
                    Ringkasan Izin
                </a>
            </div>
                ...
                <div class="card">
                    ...
                    ?>
                        <div class="card-body">
                            ...
                            <a href="../admin/report-csv.php?a=I&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-success">Export CSV</a>
                        </div>
                    <?php } else { ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
