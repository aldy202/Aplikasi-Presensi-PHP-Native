    ...
    <div class="main-container d-flex">
        ...
        <div class="content mb-2">
            ...
            <div class="tab-titles">
                ...
                <a href="ringkasan-presensi-karyawan.php" class="tab-links active-link" style="text-decoration: none;">
                    Ringkasan Presensi
                </a>
                    ...
                    ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $lam = mysqli_query($con, "SELECT * FROM user INNER JOIN absensi ON user.idpegawai = absensi.idpegawai WHERE tgl_absen  BETWEEN '$tgl1' AND '$tgl2' ORDER BY tgl_absen DESC");
                                    $no = 1;
                            ...
                            <a href="../admin/report-csv.php?a=P&&t1=<?= $tgl1 ?>&&t2=<?= $tgl2 ?>" class="btn btn-sm btn-success">Export CSV</a>
                        </div>
                    <?php } else { ?>
                        <div class="card-body">
                            <table class="table table-bordered table-sm">
                                ...
                                <tbody>
                                    <?php
                                    $query = mysqli_query($con, "SELECT * FROM user INNER JOIN absensi ON user.idpegawai = absensi.idpegawai ORDER BY tgl_absen DESC");
                                    $no = 1;
