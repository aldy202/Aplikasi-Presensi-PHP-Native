...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content mb-3">
            ...
            <!-- Form Start -->
            <form action="cuti-izin-action.php?a=I" method="post">
                                        ...
                                        <div class="col-md">
                                            <div class="mb-2">
                                                <label for="nama" class="form-label">Nama
                                                    Lengkap</label>
                                                <input type="text" class="form-control" disabled name="nama" value="<?= $name ?>" />
                                            </div>
                                            <!-- Keterangan -->
                                            <div class="mb-2">
                                                <label for="keterangan" class="form-label">Keterangan</label>
                                                <input type="text" class="form-control" name="keterangan" value="Izin" readonly />
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-md">
                                                <div class="mb-2">
                                                    ...
                                                    <div class="row mb-md-3">
                                                        ...
                                                        <div class="col">
                                                            <input type="time" name="jMulai" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                        ...
                                                        <div class="col-md mb-2">
                                                            <input type="time" name="jSelesai" class="form-control" autocomplete="off" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col">
                                                            <input type="text" placeholder="Tanggal Mulai" id="dmulai" name="tMulai" autocomplete="off" class="form-control" required>
                                                        </div>
                                                    </div>
                                                    <!-- Tanggal Mulai -->
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col">
                                                            <input type="text" placeholder="Tanggal Selesai" id="dselesai" autocomplete="off" name="tSelesai" class="form-control" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row mb-3 mt-2">
                                        <div class="col-md">
                                            <div class="form-floating">
                                                <textarea class="form-control" name="alasan" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" required></textarea>
